      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="text-center md:text-left text-xs font-bold text-slate-250 dark:text-slate-350">
            <span className="block text-slate-300 dark:text-slate-200">Bakalia Community</span>
            <span className="block text-[10px] mt-0.5 text-slate-400 dark:text-slate-500">{t("copyright")}</span>
          </div>

          {/* Quick links */}
          <div className="flex flex-wrap justify-center gap-x-5 gap-y-1.5 text-[10.5px] font-bold text-slate-350 dark:text-slate-455">
