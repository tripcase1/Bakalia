  ...
  return (
    <div className="py-10 bg-slate-50 min-h-screen">
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="fixed bottom-[calc(56px+env(safe-area-inset-bottom,0px))] sm:bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-slate-200/90 p-3 shadow-2xl lg:hidden flex items-center justify-between gap-3">
          <div>
